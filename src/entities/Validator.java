...
public class Validator {
    ...
    //O algoritmo de validação de CPF utilizado como base deste projeto está disponível no site:
    ...
    public static boolean isCpf(String preCpf) {
        ...
        //Retira os dígitos verificadores para trabalhar em cima dos 9 números mais facilmente
        ...
        //Repetição dos processos anteriores para varificar o segundo dígito verificador
        for (int i=cpf.length()-1; i>=0; i--) {
